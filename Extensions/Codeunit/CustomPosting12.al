codeunit 52185510 "Gen. Jnl.-Post Line Ext"
{
    ...
    var
        ...
        Found: Boolean;
        ProductCode: Code[20];
        DocExistsBankErr: label 'Document %1 already exists for this Bank Account.';
                ...
                if ("Bal. Account No." <> '') and
                   ...
                   ("Account Type" in
                    ["Account Type"::Customer,
                     "Account Type"::Vendor,
                     "Account Type"::Savings,//msangi
                     "Account Type"::Vendor,//msangi
    ...
    begin
        ...
        if not IsHandled then
            with GenJnlLine do begin
                ...
                //Time and Machine Name-- msangi
                // GLEntry."Creation Time":=Time;
                ...
                // GLEntry."PC Posting Name":=ActiveSession."Client Computer Name";
                //Time and Machine Name-- msangi
    ...
    // local procedure PostCredit(var GenJnlLine: Record "Gen. Journal Line";Balancing: Boolean)
    // var
    //     LineFeeNoteOnReportHist: Record "Line Fee Note on Report Hist.";
    //     Cust: Record UnknownRecord52185731;
    //     CustPostingGr: Record "Customer Posting Group";
    //     CustLedgEntry: Record UnknownRecord52185733;
    //     CVLedgEntryBuf: Record "CV Ledger Entry Buffer";
    //     TempDtldCVLedgEntryBuf: Record "Detailed CV Ledg. Entry Buffer" temporary;
    //     DtldCustLedgEntry: Record "Detailed Cust. Ledg. Entry";
    //     ReceivablesAccount: Code[20];
    ...
    //       CustLedgEntry."Customer Posting Group":=GenJnlLine."Posting Group";
    //       CustLedgEntry."Member No.":="Member No.";
    //       CustLedgEntry."Loan Span":="Loan Span";
    //       CustLedgEntry."Currency Code" := Cust."Currency Code";
    //       if Cust."Currency Code" <> '' then
    //         CustLedgEntry.Amount := GenJnlLine.Amount
    //       else
    ...
    //       TempDtldCVLedgEntryBuf.CopyFromGenJnlLine(GenJnlLine);
    //       TempDtldCVLedgEntryBuf."CV Ledger Entry No." := CustLedgEntry."Entry No.";
    //       CVLedgEntryBuf.CopyFromCreditLedgEntry(CustLedgEntry);
    //       TempDtldCVLedgEntryBuf.InsertDtldCVLedgEntry(TempDtldCVLedgEntryBuf,CVLedgEntryBuf,TRUE);
    //       CVLedgEntryBuf.Open := CVLedgEntryBuf."Remaining Amount" <> 0;
    //       CVLedgEntryBuf.Positive := CVLedgEntryBuf."Remaining Amount" > 0;
    ...
    // local procedure InitCreditLedgEntry(GenJnlLine: Record "Gen. Journal Line";var CustLedgEntry: Record 52185733)
    // begin
    //     CustLedgEntry.Init;
    //     CustLedgEntry.CopyFromGenJnlLine(GenJnlLine);
    //     CustLedgEntry."Entry No." := NextEntryNo;
