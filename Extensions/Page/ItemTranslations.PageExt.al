...
PageExtension 52185447 pageextension52185447 extends "Item Translations" 
{
    layout
    {
        modify("Item No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Item No."(Control 11)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Description 2"(Control 13)".
