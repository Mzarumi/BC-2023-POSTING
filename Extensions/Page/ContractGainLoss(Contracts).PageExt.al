...
PageExtension 52186734 pageextension52186734 extends "Contract Gain/Loss (Contracts)" 
{
    layout
    {
        modify(PeriodStart)
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "ContractFilter(Control 8)".
    ...
    //Unsupported feature: Property Modification (Id) on ""MATRIX_GenerateColumnCaptions"(PROCEDURE 1107).MatrixMgt(Variable 1002)".


    //Unsupported feature: Property Modification (Id) on ""MATRIX_GenerateColumnCaptions"(PROCEDURE 1107).RecRef(Variable 1003)".


    //Unsupported feature: Move on ""MATRIX_GenerateColumnCaptions"(PROCEDURE 1107).CurrentMatrixRecordOrdinal(Variable 1000)".


    //Unsupported feature: Move on ""MATRIX_GenerateColumnCaptions"(PROCEDURE 1107).RecRef(Variable 1003)".
