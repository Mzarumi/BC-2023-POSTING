...
PageExtension 52186708 pageextension52186708 extends "Service Credit Memo Statistics" 
{
    layout
    {
        modify(Amount)
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "Amount(Control 2)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "AdjProfitLCY(Control 36)".


        //Unsupported feature: Property Deletion (ToolTipML) on "ProfitPct(Control 32)".


        //Unsupported feature: Property Deletion (ToolTipML) on "AdjProfitPct(Control 39)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "TotalAdjCostLCY(Control 43)".


        //Unsupported feature: Property Deletion (ToolTipML) on "CostAdjmtAmountLCY(Control 41)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "CreditLimitLCY(Control 21)".
