...
PageExtension 52187101 pageextension52187101 extends "Sales Budget Overview Matrix" 
{
    layout
    {
        modify("Code")
    ...
    //Unsupported feature: Property Modification (OptionString) on "ValueType(Variable 1090)".
