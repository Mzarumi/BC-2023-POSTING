...
PageExtension 52187096 pageextension52187096 extends "Sales Analysis by Dim Matrix" 
{
    layout
    {
        modify("Code")
    ...
    //Unsupported feature: Code Modification on "FieldDrillDown(PROCEDURE 4)".

    //procedure FieldDrillDown();
    //Parameters and return type have not been exported.
    //>>>> ORIGINAL CODE:
    //begin
        /*
