...
PageExtension 52186452 pageextension52186452 extends "FA Error Ledger Entries" 
{
    layout
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Canceled from FA No."(Control 6)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Index Entry"(Control 19)".
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "Dimensions(Action 34)".
