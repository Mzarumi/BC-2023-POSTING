...
PageExtension 52185430 pageextension52185430 extends Languages 
{
    layout
    {
        modify("Code")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Windows Language ID"(Control 9)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Windows Language Name"(Control 11)".
