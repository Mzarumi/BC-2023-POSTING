...
PageExtension 52186711 pageextension52186711 extends "Service Invoice Lines Subform" 
{
    layout
    {
        modify("Document No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Serv. Price Adjmt. Gr. Code"(Control 58)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Contract No."(Control 62)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Shipment No."(Control 64)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Service Item No."(Control 66)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Appl.-to Service Entry"(Control 68)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Appl.-to Item Entry"(Control 32)".

    }
    local procedure GetSelectedLine(var FromServInvLine: Record "Service Invoice Line")
    begin
