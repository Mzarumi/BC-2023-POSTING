...
PageExtension 52186774 pageextension52186774 extends "Get Return Receipt Lines" 
{
    layout
    {
        modify("Document No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Return Qty. Rcd. Not Invd."(Control 29)".
