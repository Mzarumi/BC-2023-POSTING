...
PageExtension 52186920 pageextension52186920 extends "Phys. Invt. Counting Periods" 
{
    ...
    layout
    {
        ...
        modify("Count Frequency per Year")
        {
            ApplicationArea = Basic;
        }
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Count Frequency per Year"(Control 6)".
