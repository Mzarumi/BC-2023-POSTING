...
PageExtension 52186541 pageextension52186541 extends "Posted Transfer Receipts" 
{
    layout
    {
        modify("No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Shipment Date"(Control 1102601001)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Shipment Method Code"(Control 1102601003)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Shipping Agent Code"(Control 1102601005)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Receipt Date"(Control 1102601007)".
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (PromotedOnly) on "Statistics(Action 21)".
        ...
        //Unsupported feature: Property Deletion (PromotedOnly) on "Dimensions(Action 1102601000)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""&Print"(Action 19)".


        //Unsupported feature: Property Deletion (PromotedOnly) on ""&Print"(Action 19)".
