...
PageExtension 52186321 pageextension52186321 extends "Saved Segment Criteria Card" 
{
    layout
    {
        modify("Code")
        ...
        //Unsupported feature: Property Deletion (PartType) on "Control11(Control 11)".
