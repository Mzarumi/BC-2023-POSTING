...
PageExtension 52186757 pageextension52186757 extends "Lot No. Information List" 
{
    layout
    {
        modify("Item No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Test Quality"(Control 10)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Certificate Number"(Control 12)".
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Item &Tracking Entries"(Action 1102601001)".


        //Unsupported feature: Code Insertion on "Comment(Action 1102601002)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "Comment(Action 1102601002)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""&Item Tracing"(Action 1102601004)".


        //Unsupported feature: Property Deletion (ToolTipML) on "Navigate(Action 1102601005)".
