...
PageExtension 52185840 pageextension52185840 extends "Detailed Vendor Ledg. Entries" 
{
    ...
    layout
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Vendor No."(Control 18)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "Unapplied(Control 28)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Unapplied by Entry No."(Control 33)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Vendor Ledger Entry No."(Control 4)".
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Unapply Entries"(Action 29)".


        //Unsupported feature: Property Deletion (Promoted) on ""Unapply Entries"(Action 29)".


        //Unsupported feature: Property Deletion (PromotedCategory) on ""Unapply Entries"(Action 29)".
