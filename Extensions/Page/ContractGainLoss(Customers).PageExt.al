...
PageExtension 52186730 pageextension52186730 extends "Contract Gain/Loss (Customers)"
{
    layout
    {
        modify(PeriodStart)
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "CustomerNo(Control 1)".


        //Unsupported feature: Property Deletion (ToolTipML) on "ShipToCodeFilter(Control 2)".
