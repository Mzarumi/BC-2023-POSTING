...
PageExtension 52186533 pageextension52186533 extends "Posted Transfer Receipt" 
{
    layout
    {
        modify("No.")
        ...
        modify("Transfer-from Code")
        {
            ...
            //Unsupported feature: Property Insertion (Importance) on ""Transfer-from Code"(Control 4)".
        ...
        modify("Transfer-to Code")
        {
            ...
            //Unsupported feature: Property Insertion (Importance) on ""Transfer-to Code"(Control 6)".
        ...
        modify("Shipment Date")
        {
            ...
            //Unsupported feature: Property Insertion (Importance) on ""Shipment Date"(Control 29)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""In-Transit Code"(Control 27)".
        ...
        //Unsupported feature: Property Deletion (ApplicationArea) on "TransferReceiptLines(Control 49)".


        //Unsupported feature: Property Deletion (PartType) on "TransferReceiptLines(Control 49)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Shipment Date"(Control 29)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Shipment Method Code"(Control 67)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Shipping Agent Code"(Control 62)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Shipping Agent Service Code"(Control 64)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Receipt Date"(Control 31)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Transaction Type"(Control 78)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Transaction Specification"(Control 76)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Transport Method"(Control 74)".


        //Unsupported feature: Property Deletion (ToolTipML) on "Area(Control 72)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Entry/Exit Point"(Control 70)".
        ...
        moveafter(TransferReceiptLines;"Transfer-from")
