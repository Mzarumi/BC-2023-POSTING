...
PageExtension 52186062 pageextension52186062 extends "Job Task Dimensions Multiple" 
{
    layout
    {
    ...
    //Unsupported feature: Property Deletion (Attributes) on "SetMultiJobTask(PROCEDURE 1007)".
