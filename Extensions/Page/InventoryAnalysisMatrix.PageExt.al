...
PageExtension 52187083 pageextension52187083 extends "Inventory Analysis Matrix" 
{
    layout
    {
        modify("Row Ref. No.")
    ...
    //Unsupported feature: Property Deletion (Attributes) on "FormatStr(PROCEDURE 6)".
