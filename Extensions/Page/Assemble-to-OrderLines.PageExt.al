...
PageExtension 52186015 pageextension52186015 extends "Assemble-to-Order Lines" 
{
    layout
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Consumed Quantity"(Control 38)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Qty. Picked"(Control 41)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Pick Qty."(Control 42)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Shortcut Dimension 1 Code"(Control 9)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Shortcut Dimension 2 Code"(Control 10)".
    ...
    actions
    {
        ...
        modify("Item &Tracking Lines")
        {
            ...
            //Unsupported feature: Property Modification (PromotedCategory) on ""Item &Tracking Lines"(Action 40)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""&Reserve"(Action 37)".
        ...
        //Unsupported feature: Property Deletion (Promoted) on ""Assembly BOM"(Action 16)".


        //Unsupported feature: Property Deletion (PromotedCategory) on ""Assembly BOM"(Action 16)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Create Inventor&y Movement"(Action 44)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Show Document"(Action 36)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Item &Tracking Lines"(Action 40)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""BOM Level"(Action 43)".


        //Unsupported feature: Property Deletion (ToolTipML) on "Comments(Action 21)".


        //Unsupported feature: Property Deletion (ToolTipML) on "ShowWarning(Action 34)".
