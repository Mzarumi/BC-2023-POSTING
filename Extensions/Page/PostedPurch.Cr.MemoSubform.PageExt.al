...
PageExtension 52185522 pageextension52185522 extends "Posted Purch. Cr. Memo Subform" 
{
    layout
    {
        modify(Type)
        ...
        //     //Unsupported feature: Property Insertion (Visible) on ""Cross-Reference No."(Control 66)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Indirect Cost %"(Control 18)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Unit Cost (LCY)"(Control 50)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Unit Price (LCY)"(Control 20)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Line Discount %"(Control 16)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Line Amount"(Control 70)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Insurance No."(Control 24)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Budgeted FA No."(Control 32)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""FA Posting Type"(Control 22)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Depr. until FA Posting Date"(Control 26)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Depreciation Book Code"(Control 30)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Depr. Acquisition Cost"(Control 28)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Invoice Discount Amount"(Control 25)".
    ...
    actions
    {
        modify(DeferralSchedule)
        {
            ...
            //Unsupported feature: Property Modification (Level) on "DeferralSchedule(Action 13)".
        ...
        modify(Comments)
        {
            ...
            //Unsupported feature: Property Modification (Name) on "Comments(Action 1903099904)".
        ...
        modify(ItemReturnShipmentLines)
        {
            ...
            //Unsupported feature: Property Modification (Name) on "ItemReturnShipmentLines(Action 1901743204)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "Comments(Action 1903099904)".


        //Unsupported feature: Property Deletion (ToolTipML) on "ItemTrackingEntries(Action 1905987604)".


        //Unsupported feature: Property Deletion (ToolTipML) on "ItemReturnShipmentLines(Action 1901743204)".


        //Unsupported feature: Property Deletion (Image) on "ItemReturnShipmentLines(Action 1901743204)".
