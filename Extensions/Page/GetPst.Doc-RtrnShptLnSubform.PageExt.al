...
PageExtension 52186598 pageextension52186598 extends "Get Pst.Doc-RtrnShptLn Subform"
{
    layout
    {
        modify("Document No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Return Qty. Shipped Not Invd."(Control 38)".
