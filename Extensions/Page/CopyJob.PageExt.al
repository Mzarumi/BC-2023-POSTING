...
PageExtension 52186079 pageextension52186079 extends "Copy Job" 
{
    layout
    {
        modify(SourceJobNo)
        ...
        modify(TargetJobDescription)
        {
            ApplicationArea = Basic;
        }
        modify(TargetBillToCustomerNo)
        {
            ApplicationArea = Basic;
        }
        modify(CopyJobPrices)
        {
            ApplicationArea = Basic;
        }
        modify(CopyQuantity)
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "TargetJobDescription(Control 31)".


        //Unsupported feature: Property Deletion (ToolTipML) on "TargetBillToCustomerNo(Control 33)".


        //Unsupported feature: Property Deletion (ToolTipML) on "CopyJobPrices(Control 16)".
    ...
    //Unsupported feature: Property Modification (Length) on "TargetJobDescription(Variable 1007)".

    //var
        //>>>> ORIGINAL VALUE:
        //TargetJobDescription : 100;
        //Variable type has not been exported.
        //>>>> MODIFIED VALUE:
        //TargetJobDescription : 50;
        //Variable type has not been exported.
