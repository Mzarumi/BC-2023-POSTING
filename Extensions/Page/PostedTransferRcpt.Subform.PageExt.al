...
PageExtension 52186534 pageextension52186534 extends "Posted Transfer Rcpt. Subform" 
{
    layout
    {
        modify("Item No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Transfer-To Bin Code"(Control 8)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Shipping Time"(Control 24)".
