...
PageExtension 52186817 pageextension52186817 extends "Sales Budget Overview" 
{
    layout
    {
        ...
        //Unsupported feature: Property Deletion (ShowMandatory) on "ColumnDimCode(Control 7)".
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "DeleteBudget(Action 54)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Create New Document"(Action 38)".
    ...
    //Unsupported feature: Property Modification (OptionString) on "ValueType(Variable 1018)".

    //var
        //>>>> ORIGINAL VALUE:
        //ValueType : "Sales Amount","Cost Amount",Quantity;
        //Variable type has not been exported.
        //>>>> MODIFIED VALUE:
        //ValueType : "Sales Amount","COGS Amount",Quantity;
        //Variable type has not been exported.
    ...
    //Unsupported feature: Property Modification (Id) on ""MATRIX_GenerateColumnCaptions"(PROCEDURE 1152).MatrixMgt(Variable 1003)".


    //Unsupported feature: Property Modification (Id) on ""MATRIX_GenerateColumnCaptions"(PROCEDURE 1152).RecRef(Variable 1004)".


    //Unsupported feature: Property Modification (Id) on ""MATRIX_GenerateColumnCaptions"(PROCEDURE 1152).i(Variable 1002)".


    //Unsupported feature: Move on ""MATRIX_GenerateColumnCaptions"(PROCEDURE 1152).MatrixMgt(Variable 1003)".


    //Unsupported feature: Move on ""MATRIX_GenerateColumnCaptions"(PROCEDURE 1152).i(Variable 1002)".


    //Unsupported feature: Move on ""MATRIX_GenerateColumnCaptions"(PROCEDURE 1152).RecRef(Variable 1004)".
