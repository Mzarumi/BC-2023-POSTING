...
PageExtension 52187156 pageextension52187156 extends "Released Production Orders" 
{
    layout
    {
        modify("No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Last Date Modified"(Control 67)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Bin Code"(Control 69)".
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Create Inventor&y Put-away/Pick/Movement"(Action 153)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Production Order - Picking List"(Action 1902850806)".
