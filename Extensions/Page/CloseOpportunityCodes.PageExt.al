...
PageExtension 52186314 pageextension52186314 extends "Close Opportunity Codes" 
{
    layout
    {
        modify("Code")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""No. of Opportunities"(Control 6)".
