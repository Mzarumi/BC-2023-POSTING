...
PageExtension 52185805 pageextension52185805 extends "Posted Sales Credit Memo Lines" 
{
    layout
    {
        modify("Document No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Unit Price"(Control 28)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Unit Cost (LCY)"(Control 30)".


        //Unsupported feature: Property Deletion (ToolTipML) on "Amount(Control 32)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Amount Including VAT"(Control 34)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Allow Invoice Disc."(Control 40)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Inv. Discount Amount"(Control 42)".
