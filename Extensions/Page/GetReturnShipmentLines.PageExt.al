...
PageExtension 52186781 pageextension52186781 extends "Get Return Shipment Lines" 
{
    layout
    {
        modify("Document No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Return Reason Code"(Control 31)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Return Qty. Shipped Not Invd."(Control 20)".
