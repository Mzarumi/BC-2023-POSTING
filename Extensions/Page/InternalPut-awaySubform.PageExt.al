...
PageExtension 52186894 pageextension52186894 extends "Internal Put-away Subform" 
{
    layout
    {
        modify("Item No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""From Zone Code"(Control 42)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""From Bin Code"(Control 40)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Shelf No."(Control 6)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Qty. Put Away"(Control 12)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Qty. Put Away (Base)"(Control 18)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Put-away Qty."(Control 20)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Put-away Qty. (Base)"(Control 28)".
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Bin Contents List"(Action 1901742304)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Item &Tracking Lines"(Action 1903866904)".

    }

    //Unsupported feature: Property Deletion (Attributes) on "PutAwayCreate(PROCEDURE 1)".
