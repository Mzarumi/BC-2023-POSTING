...
PageExtension 52186924 pageextension52186924 extends "Reg. Invt. Movement Subform" 
{
    layout
    {
        modify("Action Type")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Expiration Date"(Control 60)".
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Bin Contents List"(Action 1900206304)".
