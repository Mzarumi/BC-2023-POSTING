...
PageExtension 52186494 pageextension52186494 extends "Insurance Registers"
{
    layout
    {
        modify("No.")
    ...
    actions
    {
        modify("Ins&urance Coverage Ledger")
        {
            ApplicationArea = Basic;
        }

        //Unsupported feature: Property Deletion (ToolTipML) on ""Ins&urance Coverage Ledger"(Action 20)".
