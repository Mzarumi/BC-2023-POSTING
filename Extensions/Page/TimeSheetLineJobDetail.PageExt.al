...
PageExtension 52186045 pageextension52186045 extends "Time Sheet Line Job Detail" 
{
    layout
    {
        modify("Job No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Job No."(Control 4)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Job Task No."(Control 5)".
