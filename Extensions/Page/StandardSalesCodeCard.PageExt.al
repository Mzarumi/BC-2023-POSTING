...
PageExtension 52185544 pageextension52185544 extends "Standard Sales Code Card" 
{
    Caption = 'Standard Sales Code Card';
    layout
    {
        modify("Code")
        {
        ...
        //Unsupported feature: Property Deletion (ApplicationArea) on "StdSalesLines(Control 9)".
