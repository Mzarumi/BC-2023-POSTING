...
// PageExtension 52186471 pageextension52186471 extends "Fixed Asset Journal" 
// {
...
//         //Unsupported feature: Property Deletion (ToolTipML) on ""Posting Date"(Control 58)".
...
//         //Unsupported feature: Property Deletion (ToolTipML) on ""Depreciation Book Code"(Control 17)".
...
//         //Unsupported feature: Property Deletion (ToolTipML) on ""Salvage Value"(Control 19)".


//         //Unsupported feature: Property Deletion (ToolTipML) on ""No. of Depreciation Days"(Control 23)".


//         //Unsupported feature: Property Deletion (ToolTipML) on ""Depr. until FA Posting Date"(Control 29)".


//         //Unsupported feature: Property Deletion (ToolTipML) on ""Depr. Acquisition Cost"(Control 31)".
...
//         //Unsupported feature: Property Deletion (ToolTipML) on ""Duplicate in Depreciation Book"(Control 52)".


//         //Unsupported feature: Property Deletion (ToolTipML) on ""Use Duplication List"(Control 38)".
...
//         //Unsupported feature: Property Deletion (ToolTipML) on "Dimensions(Action 61)".
