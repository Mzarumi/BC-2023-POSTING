...
PageExtension 52186392 pageextension52186392 extends "Qualification Overview" 
{
    layout
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""MATRIX_CaptionRange"(Control 13)".
    ...
    //Unsupported feature: Property Modification (Length) on ""MATRIX_CaptionSet"(Variable 1052)".
    ...
    //Unsupported feature: Property Modification (Length) on ""MATRIX_CaptionRange"(Variable 1002)".
