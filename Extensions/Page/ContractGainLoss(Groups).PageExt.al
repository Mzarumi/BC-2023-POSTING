...
PageExtension 52186729 pageextension52186729 extends "Contract Gain/Loss (Groups)"
{
    layout
    {
        modify(PeriodStart)
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "GroupFilter(Control 8)".
