...
PageExtension 52185523 pageextension52185523 extends "Posted Sales Shipments" 
{
    layout
    {
        modify("No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Requested Delivery Date"(Control 1102601006)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Shipment Method Code"(Control 1102601008)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Shipping Agent Code"(Control 1102601010)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Shipment Date"(Control 1102601012)".
    ...
    actions
    {
        modify(Statistics)
        {
            ...
            //Unsupported feature: Property Modification (PromotedCategory) on "Statistics(Action 28)".
        ...
        modify(PrintCertificateofSupply)
        {
            ...
            //Unsupported feature: Property Insertion (PromotedCategory) on "PrintCertificateofSupply(Action 7)".
        ...
        //Unsupported feature: Property Deletion (PromotedIsBig) on "Statistics(Action 28)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Co&mments"(Action 33)".


        //Unsupported feature: Property Deletion (Promoted) on ""Co&mments"(Action 33)".


        //Unsupported feature: Property Deletion (PromotedCategory) on ""Co&mments"(Action 33)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "CertificateOfSupplyDetails(Action 3)".


        //Unsupported feature: Property Deletion (ToolTipML) on "PrintCertificateofSupply(Action 7)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""&Track Package"(Action 1102601002)".
