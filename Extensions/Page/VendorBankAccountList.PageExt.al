...
PageExtension 52185713 pageextension52185713 extends "Vendor Bank Account List" 
{
    layout
    {
        modify("Code")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""SWIFT Code"(Control 6)".


        //Unsupported feature: Property Deletion (ToolTipML) on "IBAN(Control 10)".
