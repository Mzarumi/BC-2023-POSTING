...
PageExtension 52186599 pageextension52186599 extends "Get Post.Doc-P.Cr.MemoLn Sbfrm" 
{
    layout
    {
        modify("Document No.")
        ...
        modify("PurchCrMemoHeader.""Posting Date""")
        {
            ApplicationArea = Basic;
        }
        ...
        modify("PurchCrMemoHeader.""Currency Code""")
        {
            ApplicationArea = Basic;
        }
        modify("PurchCrMemoHeader.""Prices Including VAT""")
        {
            ApplicationArea = Basic;
        }
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""PurchCrMemoHeader.""Posting Date"""(Control 36)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "DirectUnitCost(Control 76)".


        //Unsupported feature: Property Deletion (ToolTipML) on "LineAmount(Control 74)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""PurchCrMemoHeader.""Currency Code"""(Control 80)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""PurchCrMemoHeader.""Prices Including VAT"""(Control 82)".
