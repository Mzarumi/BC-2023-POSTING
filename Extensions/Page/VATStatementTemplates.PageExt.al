...
PageExtension 52185634 pageextension52185634 extends "VAT Statement Templates" 
{
    layout
    {
        modify(Name)
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Statement Names"(Action 10)".
