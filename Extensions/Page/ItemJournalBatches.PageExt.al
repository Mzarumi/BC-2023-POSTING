...
PageExtension 52185599 pageextension52185599 extends "Item Journal Batches" 
{
    layout
    {
        modify(Name)
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Test Report"(Action 12)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""P&ost"(Action 13)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Post and &Print"(Action 14)".
