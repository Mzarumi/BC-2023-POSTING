...
PageExtension 52185807 pageextension52185807 extends "Posted Purchase Invoice Lines" 
{
    layout
    {
        modify("Document No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""FA Posting Type"(Control 20)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Depreciation Book Code"(Control 22)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "Amount(Control 38)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Amount Including VAT"(Control 40)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Line Discount %"(Control 42)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Line Discount Amount"(Control 44)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Allow Invoice Disc."(Control 46)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Inv. Discount Amount"(Control 48)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Appl.-to Item Entry"(Control 54)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Job No."(Control 56)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Insurance No."(Control 58)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Depr. until FA Posting Date"(Control 60)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Depr. Acquisition Cost"(Control 62)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Budgeted FA No."(Control 64)".
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Show Document"(Action 72)".


        //Unsupported feature: Property Deletion (ToolTipML) on "Dimensions(Action 73)".
