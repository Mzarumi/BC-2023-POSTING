...
PageExtension 52186731 pageextension52186731 extends "Contract Gain/Loss (Reasons)"
{
    layout
    {
        modify(PeriodStart)
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "ReasonFilter(Control 8)".
