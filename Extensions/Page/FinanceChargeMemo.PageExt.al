...
PageExtension 52185732 pageextension52185732 extends "Finance Charge Memo" 
{
    layout
    {
        modify("No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Fin. Charge Terms Code"(Control 8)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Due Date"(Control 22)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Currency Code"(Control 3)".
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "Dimensions(Action 27)".


        //Unsupported feature: Property Deletion (Promoted) on "Dimensions(Action 27)".


        //Unsupported feature: Property Deletion (Enabled) on "Dimensions(Action 27)".


        //Unsupported feature: Property Deletion (PromotedIsBig) on "Dimensions(Action 27)".


        //Unsupported feature: Property Deletion (PromotedCategory) on "Dimensions(Action 27)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "CreateFinanceChargeMemos(Action 24)".


        //Unsupported feature: Property Deletion (ToolTipML) on "SuggestFinChargeMemoLines(Action 14)".


        //Unsupported feature: Property Deletion (ToolTipML) on "UpdateFinChargeText(Action 15)".
