...
PageExtension 52185693 pageextension52185693 extends "Sales Credit Memo Statistics" 
{
    layout
    {
        ...
        modify(AdjustedProfitLCY)
        {
            ...
            //Unsupported feature: Property Modification (Name) on "AdjustedProfitLCY(Control 39)".
        ...
        modify(AdjustedCostLCY)
        {
            ...
            //Unsupported feature: Property Modification (Name) on "AdjustedCostLCY(Control 36)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "AdjustedProfitLCY(Control 39)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "AdjustedCostLCY(Control 36)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""TotalAdjCostLCY - CostLCY"(Control 44)".
