...
PageExtension 52187127 pageextension52187127 extends "Machine Center Calendar Matrix" 
{
    layout
    {
        modify("No.")
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Capacity Ledger E&ntries"(Action 8)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Co&mments"(Action 9)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Lo&ad"(Action 10)".


        //Unsupported feature: Property Deletion (ToolTipML) on "Statistics(Action 12)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""A&bsence"(Action 13)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Ta&sk List"(Action 14)".


        //Unsupported feature: Property Deletion (ToolTipML) on "Calculate(Action 15)".


        //Unsupported feature: Property Deletion (ToolTipML) on "Recalculate(Action 16)".
