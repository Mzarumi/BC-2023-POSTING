...
PageExtension 52187091 pageextension52187091 extends "ResGrp. All. per Serv.  Matrix" 
{

    //Unsupported feature: Property Insertion (DataCaptionExpr) on ""ResGrp. All. per Serv.  Matrix"(Page 9217)".
    ...
    actions
    {
        ...
        modify("Resource Gr. A&vailability")
        {
            ApplicationArea = Basic;
        }

        //Unsupported feature: Property Deletion (ToolTipML) on ""&Card"(Action 76)".


        //Unsupported feature: Property Deletion (ToolTipML) on "Costs(Action 77)".


        //Unsupported feature: Property Deletion (ToolTipML) on "Prices(Action 78)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Resource Gr. A&vailability"(Action 79)".
