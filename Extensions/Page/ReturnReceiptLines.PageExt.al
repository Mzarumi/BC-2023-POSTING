...
PageExtension 52186793 pageextension52186793 extends "Return Receipt Lines" 
{
    layout
    {
        modify("Document No.")
    ...
    //Unsupported feature: Property Deletion (Attributes) on "InitializePurchase(PROCEDURE 3)".
