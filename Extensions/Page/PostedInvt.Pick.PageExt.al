...
PageExtension 52186929 pageextension52186929 extends "Posted Invt. Pick" 
{
    layout
    {
        modify("No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Posting Date"(Control 15)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Shipment Date"(Control 4)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""External Document No."(Control 21)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""External Document No.2"(Control 20)".
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""&Navigate"(Action 7)".
