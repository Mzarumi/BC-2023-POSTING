...
PageExtension 52186027 pageextension52186027 extends "Blanket Assembly Order" 
{
    layout
    {
        modify("No.")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Starting Date"(Control 45)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Ending Date"(Control 46)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Assemble to Order"(Control 47)".
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (Enabled) on "Dimensions(Action 15)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Assembly BOM"(Action 31)".


        //Unsupported feature: Property Deletion (ToolTipML) on "Comments(Action 32)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Show Availability"(Action 41)".
