...
PageExtension 52185548 pageextension52185548 extends "Standard Purchase Code Card" 
{
    layout
    {
        modify("Code")
        ...
        //Unsupported feature: Property Deletion (ApplicationArea) on "StdPurchaseLines(Control 9)".
