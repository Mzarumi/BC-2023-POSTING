...
PageExtension 52185842 pageextension52185842 extends "VAT Specification Subform" 
{
    layout
    {
    ...
    //Unsupported feature: Property Deletion (Attributes) on "SetParentControl(PROCEDURE 6)".


    //Unsupported feature: Property Deletion (Attributes) on "SetServHeader(PROCEDURE 7)".


    //Unsupported feature: Property Deletion (Attributes) on "SetCurrentTabNo(PROCEDURE 8)".


    local procedure CurrentMainFrmTabIsPrpmt(IsPrepmtTab: Boolean)
    begin
        if IsPrepmtTab then
