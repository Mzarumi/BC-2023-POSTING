...
PageExtension 52186474 pageextension52186474 extends "FA Journal Batches" 
{
    layout
    {
        modify(Name)
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""No. Series"(Control 11)".
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Test Report"(Action 14)".
