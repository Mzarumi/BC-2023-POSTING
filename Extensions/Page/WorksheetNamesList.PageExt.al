...
PageExtension 52186885 pageextension52186885 extends "Worksheet Names List" 
{
    layout
    {
        modify(Name)
    ...
    actions
    {
        modify("Edit Worksheet")
        {
            ApplicationArea = Basic;
        }

        //Unsupported feature: Property Deletion (ToolTipML) on ""Edit Worksheet"(Action 11)".
