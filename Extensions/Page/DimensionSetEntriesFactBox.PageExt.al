...
PageExtension 52185933 pageextension52185933 extends "Dimension Set Entries FactBox" 
{
    layout
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Dimension Value Code"(Control 11)".
