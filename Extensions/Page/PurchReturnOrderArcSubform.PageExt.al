...
PageExtension 52186779 pageextension52186779 extends "Purch Return Order Arc Subform" 
{
    layout
    {
        modify(Type)
    ...
    actions
    {
        ...
        modify(Comments)
        {
            ...
            //Unsupported feature: Property Modification (Name) on "Comments(Action 1907838004)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "Comments(Action 1907838004)".
