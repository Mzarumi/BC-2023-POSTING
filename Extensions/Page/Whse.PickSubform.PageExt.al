...
PageExtension 52186557 pageextension52186557 extends "Whse. Pick Subform" 
{
    layout
    {
        modify("Action Type")
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Lot No. Blocked"(Control 70)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Zone Code"(Control 56)".
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on ""Whse. Document Type"(Control 62)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Whse. Document No."(Control 64)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Whse. Document Line No."(Control 66)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Special Equipment Code"(Control 68)".


        //Unsupported feature: Property Deletion (ToolTipML) on ""Assemble to Order"(Control 3)".
    ...
    actions
    {
        ...
        //Unsupported feature: Property Deletion (ToolTipML) on "ChangeUnitOfMeasure(Action 1900724304)".
    ...
    //Unsupported feature: Code Modification on "DeleteQtyToHandle(PROCEDURE 4)".
    ...
    //Unsupported feature: Variable Insertion (Variable: WhseRegisterActivityYesNo) (VariableCollection) on "RegisterActivityYesNo(PROCEDURE 2)".
    ...
    //Unsupported feature: Code Modification on "EnableZoneBin(PROCEDURE 6)".
