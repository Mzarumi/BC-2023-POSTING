...
// Report 52185873 "Sky Stmt Loan Report B64."
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './Layouts/Sky Stmt Loan Report B64..rdlc';
...
//             {
//             }
//             column(SasraCategorisation; SasraCategorisation)
//             {
//             }
...
//         Loan.Get(LoanNo);
//         SasraCategorisation := Format(Loan."Loans Category-SASRA");
...
//             FromdateD := "Credit Ledger Entry"."Posting Date";
//         end;
...
//             ToDateD := "Credit Ledger Entry"."Posting Date";
//         end;
...
//         Loan.SetFilter("Date Filter", Format(FromdateD) + '..' + Format(ToDateD));
//         if Loan.FindFirst then begin
//             Loan.CalcFields("Outstanding Balance", "Outstanding Interest");
//             if Loan."Outstanding Interest" < 0 then Loan."Outstanding Interest" := 0;
//             OutstandingBalance := Loan."Outstanding Balance" + Loan."Outstanding Interest";
//         end;
