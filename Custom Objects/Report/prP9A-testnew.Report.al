...
// Report 52185763 "prP9A-test  new"
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './Layouts/prP9A-test  new.rdlc';
...
//                 {
//                 }
//                 column(Allowances_prEmployeeP9Info; "PR Employee P9 Info".Allowances)
//                 {
//                 }

//                 trigger OnAfterGetRecord()
//                 var
//                     prPayrollProcess: Codeunit 52185432;
//                 begin
//                     /*IF (P9."Defined Contribution"+NSSF)>20000 THEN
//                      BEGIN
...
//                     ELSE
//                      BEGIN
//                      // ColG:=(NSSF+SelfContrib+VolPension);//+"Owner Occupier Interest";
//                        ColG:=Actual;//+"Owner Occupier Interest";
//                       TotalG:=TotalG+ColG;
//                      END;*/
...
//                     PeriodTrans.SetRange(PeriodTrans."Period Year", PeriodYear);//SelectedPeriod);//PeriodYear
//                     PeriodTrans.SetRange(PeriodTrans."Payroll Period", "Payroll Period");
//                     PeriodTrans.SetRange(PeriodTrans."Transaction Code", 'D03');
...
//                     PeriodTrans.Reset;
//                     PeriodTrans.SetRange(PeriodTrans."Employee Code", "Employee Code");
//                     PeriodTrans.SetRange(PeriodTrans."Period Year", PeriodYear);
//                     PeriodTrans.SetRange(PeriodTrans."Payroll Period", "Payroll Period");
//                     PeriodTrans.SetRange(PeriodTrans."Transaction Code", 'D14');


//                     if PeriodTrans.Find('-') then begin
//                         repeat
//                             VolNSSF := PeriodTrans.Amount;
//                         until PeriodTrans.Next = 0;
//                     end;
...
//                     PeriodTrans.SetRange(PeriodTrans."Period Year", PeriodYear);
//                     PeriodTrans.SetRange(PeriodTrans."Payroll Period", "Payroll Period");
//                     PeriodTrans.SetRange(PeriodTrans."Transaction Code", 'D12');
//                     if PeriodTrans.Find('-') then begin
//                         repeat
//                             VolPension := PeriodTrans.Amount;
//                         until PeriodTrans.Next = 0;
//                     end;

//                     Actual := (P9.NSSF + SelfContrib + VolPension + VolNSSF);
//                     if Actual > fixedDefContri then
//                         ColG := fixedDefContri else
//                         ColG := (P9.NSSF + SelfContrib + VolPension + VolNSSF);
//                     TotalG := TotalG + ColG;
//                     TotalBenefits := ("PR Employee P9 Info".Allowances + "PR Employee P9 Info".Benefits);


//                     PeriodTrans.Reset;
//                     PeriodTrans.SetRange(PeriodTrans."Employee Code", "PR Employee P9 Info"."Employee Code");
//                     PeriodTrans.SetRange(PeriodTrans."Period Year", PeriodYear);
//                     PeriodTrans.SetRange(PeriodTrans."Payroll Period", "PR Employee P9 Info"."Payroll Period");
//                     PeriodTrans.SetRange(PeriodTrans."Transaction Code", 'MORG-RL');
//                     if PeriodTrans.Find('-') then begin
//                         repeat
//                             Mortgage := PeriodTrans.Amount;
//                         until PeriodTrans.Next = 0;
//                     end;

//                     if "PR Employee P9 Info"."Tax Charged" = 0 then begin
//                         PeriodTrans.Reset;
//                         PeriodTrans.SetRange("Employee Code", "PR Employee P9 Info"."Employee Code");
//                         PeriodTrans.SetRange(PeriodTrans."Period Year", PeriodYear);
//                         PeriodTrans.SetRange(PeriodTrans."Payroll Period", "PR Employee P9 Info"."Payroll Period");
//                         PeriodTrans.SetRange("Transaction Code", 'TXBP');
//                         if PeriodTrans.Find('-') then
//                             "PR Employee P9 Info"."Tax Charged" := PRPayrollProcessing.fnGetEmployeePaye(PeriodTrans.Amount);
//                         "PR Employee P9 Info".Modify;
//                     end;
...
//                 begin
//                     "PR Employee P9 Info".SetFilter("PR Employee P9 Info"."Period Year", Format(PeriodYear));
//                 end;
//             }
...
//                 P9.SetRange(P9."Period Year", PeriodYear);
...
//                     until P9.Next = 0;
//                 end;
//                 // MESSAGE(FORMAT(P9.NSSF));
//                 // MESSAGE(FORMAT(SelfContrib));
//                 // MESSAGE(FORMAT(VolPension));
//                 // MESSAGE(FORMAT(VolNSSF));
...
//         strPin: Text[30];
//         EmployerPIN: Text[30];
//         SelectedPeriod: Option "2017","2018","2019","2020","2021","2022","2023","2024","2025","2026","2027","2028","2029","2030";
...
//         HCaptionLbl: label 'H';
//         JCaptionLbl: label 'J';
//         V1_162_00CaptionLbl: label '1,280.00';
//         KCaptionLbl: label 'K';
//         V0CaptionLbl: label '0';
//         LCaptionLbl: label 'L';
//         Total__Kshs___1_162_00CaptionLbl: label 'Total (Kshs) \1,280.00';
...
//     procedure SetPeriodYear(Year: Integer)
//     begin
//         PeriodYear := Year;
//     end;
// }
