...
Report 52185959 "Loans Movement Report II"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Loan; Loans)
        {
            ...
            begin
                ...
                LowerDateLimit := Loan.GetRangeMin("Date Filter");
                ...
                if Loans.Find('-') then begin
                    ...
                    BalanceBF := Loans."Total Loan Balance";
                end;
                Loans.Reset;
                Loans.SetRange("Loan No.", Loan."Loan No.");
                Loans.SetRange(Posted, true);
                ...
                if Loans.Find('-') then begin
                    Loans.CalcFields("Total Loan Balance");
                    BalanceCF := Loans."Total Loan Balance";
                end;
