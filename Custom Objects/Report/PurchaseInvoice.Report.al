...
// Report 52185811 "Purchase Invoice"
// {
//     DefaultLayout = RDLC;
...
//                         {
//                         }
//                         column(PayeeText; PayeeText)
//                         {
//                         }
//                         column(ContactPersonText; ContactPersonText)
//                         {
//                         }
...
//                 {
//                 }
//                 column(SequenceNo_PostedApprovalEntry; "Posted Approval Entry"."Sequence No.")
//                 {
//                 }
//                 column(SenderID_PostedApprovalEntry; "Posted Approval Entry"."Sender ID")
//                 {
//                 }
//                 column(ApproverID_PostedApprovalEntry; "Posted Approval Entry"."Approver ID")
//                 {
//                 }
//                 column(DateTimeSentforApproval_PostedApprovalEntry; "Posted Approval Entry"."Date-Time Sent for Approval")
//                 {
//                 }
//                 column(LastDateTimeModified_PostedApprovalEntry; "Posted Approval Entry"."Last Date-Time Modified")
//                 {
//                 }
//             }
...
//                     PurchaserEmail := SalesPurchPerson."E-Mail";
//                     PurchaserPhone := SalesPurchPerson."Phone No.";
//                 end;
...
//         PayeeText: label 'Make all cheques payable to ';
//         ContactPersonText: label 'Contact Person';
//         PurchaserEmail: Text;
//         PurchaserPhone: Text;
