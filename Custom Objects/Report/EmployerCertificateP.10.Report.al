...
// Report 52185539 "Employer Certificate P.10"
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './Layouts/Employer Certificate P.10.rdlc';

//     dataset
//     {
//         dataitem(52185613;52185613)
//         {
...
//             begin
//                 "PR Payroll Periods".CalcFields("PR Payroll Periods"."Opened By");
//                 TotalTax := TotalTax;
//             end;

//             trigger OnPreDataItem()
//             begin
//                 "PR Payroll Periods".SetRange("PR Payroll Periods"."Date Opened", StringDate, EndDate);
...
//         EmployeeLedger: Record 52185624;
