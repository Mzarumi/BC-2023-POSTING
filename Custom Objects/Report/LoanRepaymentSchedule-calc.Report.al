...
Report 52185927 "Loan Repayment Schedule-calc"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Loan Repayment Schedule-calc.rdlc';
    ...
    dataset
    {
        dataitem(Loans; Loans)
        {
            ...
            column(RecommendedAmount_Loans; Loans."Recommended Amount")
            {
            }
            dataitem("Loan Repayment Schedule"; "Loan Repayment Schedule")
            {
                ...
                begin
                    LastFieldNo := "Loan Repayment Schedule".FieldNo("Member No.");
                    i := 0;
                    j := 0;
                    i2 := 0;
                end;
