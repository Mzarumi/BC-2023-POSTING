...
Report 52185694 "Pension Summary"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Pension Summary.rdlc';
    ...
    dataset
    {
        ...
        dataitem("HR EMPLOYEES";"HR EMPLOYEES")
        {
            ...
            column(prPayrollPeriodsDateOpened; "PR Payroll Periods"."Period Month")
            {
            }
            column(Periodyear; "PR Payroll Periods"."Period Year")
            {
            }
            column(TestH; TestH)
            {
            ...
            begin
                ...
                PrEmpDed.Reset;
                PrEmpDed.SetRange(PrEmpDed."Employee Code", "No.");
                PrEmpDed.SetRange(PrEmpDed."Payroll Period", SelectedPeriod);
                PrEmpDed.SetRange(PrEmpDed."Transaction Code", 'D03');
                if PrEmpDed.Find('-') then begin
                    PensEmpDed := PrEmpDed.Amount * 2;
                end;
                ...
                if PeriodTrans.Find('-') then
                    repeat
                       ...
                       */
                        ...
                        if (PeriodTrans."Group Order" = 8) and (PeriodTrans."Sub Group Order" = 0) then begin
                            if PeriodTrans."Transaction Code" = 'D003' then begin
                        ...
                        if (PeriodTrans."Group Order" = 8) and (PeriodTrans."Sub Group Order" = 0) then begin
                            if PeriodTrans."Transaction Code" = 'D006' then begin
                        ...
                        if (PeriodTrans."Group Order" = 8) and (PeriodTrans."Sub Group Order" = 0) then begin
                            if PeriodTrans."Transaction Code" = 'D007' then begin
                        ...
                        //HELB Contribution***************************START
                        if (PeriodTrans."Group Order" = 8) and (PeriodTrans."Sub Group Order" = 0) then begin
                            if PeriodTrans."Transaction Code" = 'D008' then begin
                ...
                //MESSAGE('TotPension is %1',TotPension);
    ...
    begin
        ...
        SelectedPeriod := "PR Payroll Periods".GetRangeMin("Date Opened");
