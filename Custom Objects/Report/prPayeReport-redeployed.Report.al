...
Report 52185597 "prPaye Report-redeployed"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/prPaye Report-redeployed.rdlc';
            ...
            begin
                ...
                if prPeriodTrans.FindSet then
                    repeat
                        ...
                        if prPeriodTrans."Transaction Code" = 'TXCHRG' then Paye := prPeriodTrans.Amount;
