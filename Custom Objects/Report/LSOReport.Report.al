...
Report 52185937 "LSO Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/LSO Report.rdlc';
    Caption = 'Order';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(DocumentNumber; "Purchase Header"."Document Date")
            {
            }
            ...
            column(VAddress; "Purchase Header"."Buy-from Address 2")
            {
            }
            ...
            // column(QuotationNO; "Purchase Header"."Quotation No.")
            // {
            // }
            // column(QuotationDate; "Purchase Header"."Quotation Date")
            // {
            // }
            // column(ContractRefNo; "Purchase Header"."Contract Ref No")
            // {
            // }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(DocumentNo_PurchLine; PurchLine."Document No.")
                        {
                        }
                        ...
                        begin
                            ...
                            DocNo := PurchLine."Requisition No";
                        end;
                    }
