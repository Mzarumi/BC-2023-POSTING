...
// Report 52185902 "Member Statement-Detailed"
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './Layouts/Member Statement-Detailed.rdlc';
...
//                     begin
//                         if ShowSavings = false then CurrReport.Skip;
...
//                 DataItemLink = "Member No." = field("No.");
//                 DataItemTableView = sorting("No.");
//                 RequestFilterFields = "Product Category";
...
//                 {
//                 }
//                 column(Sasra_Cat; Loans."Loans Category-SASRA")
//                 {
//                 }
...
//                         if ShowLoans = false then CurrReport.Skip;
...
//                 if (ShowLoans = false) and (ShowSavings = false) then begin
//                     ShowLoans := true;
//                     ShowSavings := true;
//                 end
//             end;
