...
// Report 52185877 "Sky P9 B64"
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './Layouts/Sky P9 B64.rdlc';
...
//                     PeriodTrans.SetRange(PeriodTrans."Period Year", "HR Employees".Year);//SelectedPeriod);//PeriodYear
...
//                 begin
//                     "PR Employee P9 Info".SetFilter("PR Employee P9 Info"."Period Year", Format("HR Employees".Year));
//                 end;
//             }
...
//                 P9.SetRange(P9."Period Year", "HR Employees".Year);
...
//         PeriodYearText := "HR Employees".GetFilter(Year);
//         Evaluate(PeriodYear, PeriodYearText);
//     end;
