...
Report 52185709 "Bank Acc. Recon Manual new"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Bank Acc. Recon Manual new.rdlc';
    ...
    dataset
    {
        dataitem("Bank Acc. Reconciliation Line"; "Bank Acc. Reconciliation Line")
        {
            ...
            begin
                ...
                //IF (((CashBkBal + (TotalUnpresentedChqs*-1) - UncreditedChqs) + DiffrenceTotal ) = BankAccReconciliation."Statement Ending Balance") THEN
                if ((CashBkBal + TotalUnpresentedChqs - UncreditedChqs) + TotalDifference - DiffrenceTotal = BankAccReconciliation."Statement Ending Balance") then begin
