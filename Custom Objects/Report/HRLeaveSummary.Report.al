...
Report 52185485 "HR Leave Summary"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/HR Leave Summary.rdlc';
    ...
    dataset
    {
        dataitem("HR Leave Application";"HR Leave Application")
        {
            ...
            {
                DataItemLink = "No."=field("Applicant Staff No.");
                column(ReportForNavId_1102755010; 1102755010)
                {
                }
                // column(Total_Leave_Days;"HR Employees"."Total (Leave Days)")
                // {
                // }
