...
Codeunit 52185495 "Process Bank Acc. Rec Lines-2"
{
    TableNo = 52185972;
    ...
    var
        ...
        BankAccReconLine: Record 52185972;
    ...
    begin
        ...
        PostExchMapping.Get(PostExchDef.Code, PostExchLineDef.Code, Database::"Bank Acc. Statement Line");
    ...
    local procedure CreateBankAccRecLineTemplate(var BankAccReconLine: Record 52185972; BankAccRecon: Record "Bank Acc. Reconciliation"; PostExch: Record "Data Exch.")
    begin
