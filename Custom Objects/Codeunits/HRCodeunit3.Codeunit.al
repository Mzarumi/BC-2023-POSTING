...
Codeunit 52185504 "HR Codeunit3"
{
    ...
    procedure fn_CheckIDNumber(curr_IDNo: Integer) Exists: Boolean
    var
    ...
    begin
        ...
        if StrLen(Reason2) <= 0 then begin
    ...
    var
        HRSuggPart: Report 52185506;
        SourceTableRec: Integer;
        HRTrainLines: Record 52185583;
    begin
