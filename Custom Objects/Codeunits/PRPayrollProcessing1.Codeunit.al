...
Codeunit 52185432 "PR Payroll Processing1"
{
    // ++Note
        ...
        */
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
         ...
         if curPensionStaff > 0 then begin
             ...
             strTransDescription := 'Pension Self';
        ...
        PRTransCode_2.Reset;
        // PRTransCode_2.SetRange(PRTransCode_2."Transaction Type",PRTransCode_2."transaction type"::);
