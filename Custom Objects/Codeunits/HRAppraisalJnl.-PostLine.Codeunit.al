...
Codeunit 52185450 "HR Appraisal Jnl.-Post Line"
{
    ...
    var
        ...
        FA: Record 52185517;
        Insurance: Record 52185586;
        InsuranceJnlLine: Record 52186145;
        InsCoverageLedgEntry: Record 52185514;
        InsCoverageLedgEntry2: Record 52185514;
        InsuranceReg: Record 52186146;
        ...
        NextEntryNo: Integer;
        TempJnlLineDim: Record 52186156;
        TempJnlLineDim2: Record 52186156;


    procedure RunWithCheck(var InsuranceJnlLine2: Record 52186145; TempJnlLineDim2: Record 52186156)
    begin
    ...
    procedure RunWithOutCheck(var InsuranceJnlLine2: Record 52186145; TempJnlLineDim: Record 52186156)
    begin
        InsuranceJnlLine.Copy(InsuranceJnlLine2);
