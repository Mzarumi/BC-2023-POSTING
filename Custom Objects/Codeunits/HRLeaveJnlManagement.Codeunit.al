...
Codeunit 52185445 "HR Leave Jnl Management"
{
    ...
    procedure TemplateSelection(FormID: Integer; var InsuranceJnlLine: Record 52185544; var JnlSelected: Boolean)
    var
    ...
    procedure TemplateSelectionFromBatch(var InsuranceJnlBatch: Record 52185534)
    var
    ...
    procedure OpenJournal(var CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 52185544)
    begin
    ...
    procedure OpenJnlBatch(var InsuranceJnlBatch: Record 52185534)
    var
        InsuranceJnlTemplate: Record 52185533;
        InsuranceJnlLine: Record 52185544;
        JnlSelected: Boolean;
    begin
    ...
    procedure CheckName(CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 52185544)
    var
    ...
    procedure SetName(CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 52185544)
    begin
        InsuranceJnlLine.FilterGroup := 2;
        InsuranceJnlLine.SetRange("Journal Batch Name", CurrentJnlBatchName);
        InsuranceJnlLine.FilterGroup := 0;
    ...
    procedure LookupName(var CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 52185544): Boolean
    var
        InsuranceJnlBatch: Record 52185534;
    begin
        Commit;
    ...
    procedure GetDescriptions(InsuranceJnlLine: Record 52185544; var InsuranceDescription: Text[30]; var FADescription: Text[30])
    var
