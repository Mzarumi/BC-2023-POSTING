page 52185964 "Cancelled Staff Claims List"
{
        ...
        area(processing)
        {
            group("&Functions")
            {
                ...
                action("Check Budgetary Availability")
                {
                    ...
                    begin
                        ...
                        //here//CheckBudgetAvail.CheckStaffClaim(Rec);
                    end;
                }
            ...
            group(Navigate)
            {
                ...
                action(Approvals)
                {
                    ...
                    begin
                        ApprovalEntries.Setfilters(DATABASE::"Staff Claims Header", DocType::" ", Rec."No.");
                        ApprovalEntries.Run;
                    end;
                }
            }
