page 52185508 "HR Job Applicants Qualified L"
{
                ...
                action("Send Interview Invitation")
                {
                    ...
                    begin
                        ...
                        begin
                            ...
                            // mailParameters.Subject, 'Dear' + ' ' + HRJobApplications."First Name" + '<BR><br>' + HREmailParameters.Body + ' '
                            // RJobApplications."Job Applied for Description" + ' ' + 'applied on ' + Format("Date Applied") + ' ' + HREmailParameters."Body 2" + '<br>'
                            // REmailParameters."Body 3" + ' ' + Format(HRJobApplications."Date of Interview") + ' '
