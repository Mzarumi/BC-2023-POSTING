page 52185777 "Savings  Ledg. Entr. Preview"
{
    Caption = 'Savings  Ledg. Entr. Preview';
        ...
        area(navigation)
        {
            group("Ent&ry")
            {
                ...
                action(Dimensions)
                {
                    ...
                    begin
                        GenJnlPostPreview.ShowDimensions(DATABASE::"Savings Ledger Entry", Rec."Entry No.", Rec."Dimension Set ID");
                    end;
                }
            }
        }
