page 52185928 "Payment Vouchers List"
{
    ...
    trigger OnOpenPage()
    begin
        Rec.SetFilter(Rec.Cashier, UserId);
        //SETFILTER(Date,'>01/01/2022');
        /*
    ...
    begin
        ...
        */
        if Rec.Cashier = '' then
            if UserId <> Rec.Cashier then Error('You cannot edit a page that you did not create');
