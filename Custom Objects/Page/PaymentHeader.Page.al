page 52185926 "Payment Header"
{
        ...
        area(processing)
        {
            group("&Functions")
            {
                ...
                action("Post Payment")
                {
                    ...
                    begin
                        //check if backdated
                        //IF ("Payment Release Date" < TODAY) OR ("Payment Release Date"<>123118D ) THEN ERROR('You cannot backdate a payment. Please review payment release date');
                ...
                action("Cheque Confirmation")
                {
                    ...
                    begin
                        ...
                        */
                        ...
                        //REPORT.Run(52185830, true, true, Bank);
            ...
            group(Approval)
            {
                ...
                action("Reset Date to 31st Dec 2018")
                {
                    Image = ResetStatus;
                    ...
                    begin
                        ...
                        Payments.SetFilter(Cashier, 'HARAMBEESACCO\JMUTUKU');
                        if Payments.Find('-') then begin
                            Rec."Payment Release Date" := 20181231D;
                            Rec.Date := 20181231D;
                            Rec.Modify;
                        end;
                    end;
    ...
    begin
        ...
        UpdateControls;
        Payments.Reset;
        Payments.SetRange(Payments.Cashier, UserId);
        Payments.SetRange(Payments.Posted, false);
        Payments.SetRange(Status, Payments.Status::Pending);
        if Payments.FindFirst then begin
            if Payments.Count >= 1 then begin
    ...
    begin
        ...
        // IF Cashier<>'' THEN
        //  IF USERID<>Cashier THEN ERROR('You cannot edit a card that you did not create');
    end;
