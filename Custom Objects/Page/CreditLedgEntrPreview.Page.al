page 52186650 "Credit Ledg. Entr. Preview"
{
    Caption = 'Credit  Ledg. Entr. Preview';
    DataCaptionFields = "No. Series";
    Editable = false;
    PageType = List;
        ...
        area(navigation)
        {
            group("Ent&ry")
            {
                ...
                action(Dimensions)
                {
                    ...
                    begin
                        GenJnlPostPreview.ShowDimensions(DATABASE::"Credit Ledger Entry", Rec."Entry No.", Rec."Dimension Set ID");
                    end;
                }
            }
        }
