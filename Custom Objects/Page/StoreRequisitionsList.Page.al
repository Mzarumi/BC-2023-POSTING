page 52185933 "Store Requisitions List"
{
    ...
    SourceTableView = WHERE(Status = FILTER(Open | Released | "Pending Approval" | "Pending Prepayment"),
                            "Request date" = FILTER(>= 20210101D));
