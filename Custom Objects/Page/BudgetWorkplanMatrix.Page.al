page 52186152 "Budget Workplan Matrix"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                // field(Field1; Rec.MATRIX_CellData[1])
                // {
                //     BlankZero = true;
                ...
                //     end;
                // }
                // field(Field2; Rec.MATRIX_CellData[2])
                // {
                //     BlankZero = true;
                ...
                //     end;
                // }
                // field(Field3; Rec.MATRIX_CellData[3])
                // {
                //     BlankZero = true;
                ...
                //     end;
                // }
                // field(Field4; Rec.MATRIX_CellData[4])
                // {
                //     BlankZero = true;
                ...
                //     end;
                // }
                // field(Field5; Rec.MATRIX_CellData[5])
                // {
                //     BlankZero = true;
                ...
                //     end;
                // }
                // field(Field6; Rec.MATRIX_CellData[6])
                // {
                //     BlankZero = true;
                ...
                //     end;
                // }
                // field(Field7; Rec.MATRIX_CellData[7])
                // {
                //     BlankZero = true;
                ...
                //     end;
                // }
                // field(Field8; Rec.MATRIX_CellData[8])
                // {
                //     BlankZero = true;
                ...
                //     end;
                // }
                // field(Field9; Rec.MATRIX_CellData[9])
                // {
                //     BlankZero = true;
                ...
                //     end;
                // }
                // field(Field10; Rec.MATRIX_CellData[10])
                // {
                //     BlankZero = true;
                ...
                //     end;
                // }
                // field(Field11; Rec.MATRIX_CellData[11])
                // {
                //     BlankZero = true;
                ...
                //     end;
                // }
                // field(Field12; Rec.MATRIX_CellData[12])
                // {
                //     BlankZero = true;
    ...
    begin
        with TheGLAccBudgetBuf do begin
            Reset;
            SetRange("Budget Filter", GLBudgetName."Workplan Code");
            if BusUnitFilter <> '' then
    ...
    begin
        ...
        with GLBudgetEntry do
            ...
            then
                SetCurrentKey("Workplan Code", "Activity Code", "Business Unit Code", "Global Dimension 1 Code")
            else
                SetCurrentKey("Workplan Code", "Activity Code", Date);
    ...
    begin
        with TheDimCodeBuf do begin
            Init;
            Code := TheGLAcc."Activity Code";
            Name := TheGLAcc."Activity Description";
            Totaling := TheGLAcc.Totaling;
            Indentation := TheGLAcc.Indentation;
            "Show in Bold" := TheGLAcc."Account Type" <> TheGLAcc."Account Type"::Posting;
        end;
