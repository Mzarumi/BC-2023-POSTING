page 52185651 "Directors Salary List"
{
    ...
    //"Payroll Type" = CONST(Consultants));
            ...
            action("View Payslip")
            {
                ...
                begin
                    ...
                    */
                    ...
                    //REPORT.Run(52185621, true, false, HrEmployee);
                        ...
                        repeat
                            ...
                            if not SalCard."Suspend Pay" then begin
                                ...
                                if SalCard.Get(HrEmployee."No.") then
                                    //HrEmployee.TestField(HrEmployee.Rec."Date Of Join");
                                //PKK Check NHF Age
                                ...
                                //PKK Check NHF Age
                                //HrEmployee.TestField(HrEmployee.Rec."Date Of Join");
                                // ProcessPayroll.fnProcesspayroll(HrEmployee."No.", HrEmployee.Rec."Date Of Join", SalCard."Basic Pay", SalCard."Pays PAYE"
