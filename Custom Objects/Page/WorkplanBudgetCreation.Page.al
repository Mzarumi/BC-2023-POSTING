page 52186155 "Workplan Budget Creation"
{
    PageType = List;
    ...
    begin
        ...
        Budget.Reset;
        // Budget.SetRange(Budget."Workplan Code", Name);
    ...
    begin
        // Rec.SetRange("Line No.", "Line No.");
        //BudgetAllocation.CreateBudgetFromWorkplan(Rec);here
    end;
}
