page 52185974 "End Year Review"
{
    ...
    begin
        ...
        //"Perspective Type" := "Perspective Type"::"Training and Development";
    end;
    ...
    begin
        // CalcFields("Appraisal Type", Status);

        // if ("Appraisal Type" = "Appraisal Type"::"Target Setting") then begin
        ...
        //     SelfRating := false;
        // end else
        //     if ("Appraisal Type" = "Appraisal Type"::"Quarter 1") then begin
        ...
        //         SelfRating := true;
        //     end else
        //         if ("Appraisal Type" = "Appraisal Type"::"Appraisal Review") then begin
        //             TargetSettingStatus := false;
