page 52186373 "Internet Loan Application Card"
{
    DeleteAllowed = false;
    InsertAllowed = false;
    PageType = Card;
        ...
        area(creation)
        {
            ...
            action("Loan Appraisal Report")
            {
                ...
                begin
                    ...
                    if LoanGua.Find('-') then begin
                        repeat
                            if SavAcc.Get(LoanGua."Savings Account No./Member No.") then
                                if SavAcc.Status <> SavAcc.Status::Active then
                                    Error('Savings A/C %1 is not active', SavAcc."No.");
                ...
                begin
                    ...
                    if Rec.Status = Rec.Status::Open then begin
                        ...
                        if Rec."Approved Amount" <= 0 then
                            Error(Text015);
                        if Rec."Recommended Amount" <= 0 then
                            Error(Text016);
            ...
            action("Re-Open")
            {
                ...
                begin
                    if Rec.Status <> Rec.Status::Open then begin
                        ...
                        Rec.Status := Rec.Status::Open;
                        Rec.Modify;
                        Message('Document open successffuly');
                    end;
                end;
            }
            action("Post Loan")
            {
                ...
                begin
                    ...
                    if Confirm('Are you sure you want to post the Loan?', false) = true then begin
                        Rec.TestField("Loan Account");
    ...
    var
        ...
        Text015: Label 'Approved Amount must be greater than Zero';
        Text016: Label 'Recommended Amount must be greater than Zero';
