page 52186222 "Bill Unit Meter Ratings"
{
    //       GenJl.RESET;
    //       GenJl.INIT;
    //             "LineNo.":="LineNo."+1000;
        ...
        area(processing)
        {
            ...
            action(Post)
            {
                ...
                begin
                    ...
                    BillUnit.Reset;
                    BillUnit.SetFilter(BillUnit.Select, Format(true));
                    if BillUnit.FindFirst then begin
                        if BillUnit."G/L Account" = '' then
                            Error('Specify the G/L Account');
                        ...
                        repeat
                            ...
                            if L.Find('-') then begin
                                ...
                                GenJl."Document No." := Rec."B/Hole water bill No.";
                                GenJl."Account Type" := GenJl."Account Type"::Customer;
                                ...
                                // GenJl."Transaction Name":="G/L Description";
                                GenJl.Description := Rec."G/L Description";
                                ...
                                L.Reset;
                                L.SetRange(L."Tenant No.", Rec."Tenant No.");
                                if L.Find('-') then begin
                                    repeat
                                        //MESSAGE(FORMAT(L."No."));
                                        L."Previous Reading" := Rec."Previous Reading";
                                        L."Current Reading" := Rec."Current Reading";
                                        L.Modify;
                                    until L.Next = 0;
                                end;
