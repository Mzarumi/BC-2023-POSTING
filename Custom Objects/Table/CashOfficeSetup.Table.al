table 52185887 "Cash Office Setup"
{
    ...
    fields
    {
        ...
        field(50075; "Case Number"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50076; "Damage Number"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50077; "Surety No"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50078; "Insurance Receivable Claim"; Code[20])
        {
            TableRelation = Customer."No." WHERE ("Account Type" = CONST (SinkFund));
        }
        field(50079; "Insurance Claim Received"; Code[20])
        {
            TableRelation = Vendor."No." WHERE ("Vendor Type" = CONST (SinkFund));
        }
        field(50080; "Sundry Income for Account  Clo"; Code[20])
        {
            TableRelation = "G/L Account";
        }
        field(50081; "Staff PVs Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50082; "Permission Requisition Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50083; "Computer Asset Requisition"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50084; "Delegate  PVs Nos."; Code[20])
        {
            TableRelation = "No. Series";
        }
    }
