table 52185579 "HR Asset Transfer Lines"
{
        ...
        field(2; "Asset No."; Code[20])
        {
            ...
            begin
                if fasset.Get("Asset No.") then begin
                    ...
                    if HRTAB.Get("Responsible Employee Code") then "Employee Name" := HRTAB."Plan No." + ' ' + HRTAB."Job Title";
        ...
        field(10; "New Responsible Employee Code"; Code[20])
        {
            ...
            begin
                ...
                if HRTAB.Get("New Responsible Employee Code") then begin
                    "New Employee Name" := HRTAB."Plan No." + ' ' + HRTAB."Job Title";
                end else begin
                    "New Employee Name" := '';
                end;
            end;
    ...
    var
        ...
        HRTAB: Record "HR Succession Job Rotation";
