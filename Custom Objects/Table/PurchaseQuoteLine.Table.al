table 52185927 "Purchase Quote Line"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Lookup("Purchase Quote Header".Status WHERE("No." = FIELD("Document No.")));
            Caption = 'Status';
            Editable = false;
            FieldClass = FlowField;
        ...
        {
            CalcFormula = Sum("Purch. Rcpt. Line".Quantity WHERE("Line No." = FIELD("Line No.")));
