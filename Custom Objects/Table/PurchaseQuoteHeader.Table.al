table 52185926 "Purchase Quote Header"
{
    ...
    fields
    {
        ...
        field(19; "Expected Opening Date"; DateTime)
        {
            ...
            begin
                if "Expected Opening Date" < "Expected Closing Date" then
                    Error('Expected opening date ' + Format("Expected Opening Date") + ' cannot be less than expected closing date ' + Format("Expected Closing Date"));
            end;
        }
        ...
        field(21; "Expected Closing Date"; DateTime)
        {
            ...
            trigger OnValidate()
            begin
                if "Expected Opening Date" <> 0DT then begin
                    if "Expected Opening Date" < "Expected Closing Date" then
                        Error('Expected opening date ' + Format("Expected Opening Date") + ' cannot be less than expected closing date ' + Format("Expected Closing Date"));
                end;
            end;
        ...
        field(99008522; "Tender Expiry Date"; DateTime)
        {
        }
        field(99008523; Reference; Text[30])
        {
        }
        field(99008524; "Contract Ref No."; Code[20])
        {
        }
        field(99008525; "Quotation Date"; Date)
        {
        }
        field(99008526; "Order Date"; Date)
        {
        }
    }
    ...
    begin
        ...
        if "No." = '' then begin
            ...
            //NoSeriesMgtInitSeries(PurchSetup."Quotation Request No", xRec."No. Series", Today, "No.", "No. Series");
        end;
    ...
    begin
        if xRec."No." <> "No." then begin
            PurchSetup.Get();
            //NoSeriesMgtTestManual(PurchSetup."Quotation Request No");
        end;
    end;
