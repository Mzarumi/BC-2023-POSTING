table 52185493 "Sky Agent Transfer"
{
    ...
    fields
    {
        ...
        field(50057; "Rejection Reason"; Text[50])
        {
        }
        field(50058; Rejected; Boolean)
        {
            Editable = false;
        }
        field(50059; "Rejected By"; Code[30])
        {
            Editable = false;
        }
    }
