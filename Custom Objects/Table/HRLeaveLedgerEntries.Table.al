table 52185537 "HR Leave Ledger Entries"
{
    ...
    fields
    {
        ...
        field(29; "Leave Recalled No."; Code[20])
        {
            ...
            TableRelation = "HR Leave Application"."Application Code" WHERE("Applicant Staff No." = FIELD("Staff No."));
        }
