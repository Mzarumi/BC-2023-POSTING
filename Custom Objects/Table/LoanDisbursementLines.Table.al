table 52185737 "Loan Disbursement Lines"
{
    ...
    fields
    {
        ...
        field(16; "Loan No."; Code[20])
        {
            ...
            begin
                ...
                LoanDisb.Reset;
                LoanDisb.SetRange(LoanDisb."Loan No.", Rec."Loan No.");
                if LoanDisb.Find('-') then Error('loan' + LoanDisb."Loan No." + ' is batched on' + ' ' + LoanDisb.No);
    ...
    var
        ...
        LoanDisb: Record "Loan Disbursement Lines";
}
