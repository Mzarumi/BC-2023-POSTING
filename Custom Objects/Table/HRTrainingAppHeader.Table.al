table 52185580 "HR Training App Header"
{
    ...
    fields
    {
        ...
        field(5; "Course Title"; Code[20])
        {
            ...
            begin
                ...
                if HRTrainingNeeds.Get("Course Title") then begin
                    ...
                    Duration := HRTrainingNeeds.Duration1;
        ...
        field(13; "Training Institution Name"; Text[30])
        {
        }
        field(14; "Training Venue"; Text[100])
        {
        }
        ...
        field(25; "Training Institution"; Code[50])
        {
    ...
    begin
        if "Application No" = '' then begin
            ...
            //NoSeriesMgtInitSeries(HRSetup."Training Application Nos.", xRec."No. Series", 0D, "Application No", "No. Series");
        end;
