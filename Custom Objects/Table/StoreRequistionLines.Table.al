table 52185869 "Store Requistion Lines"
{
    ...
    fields
    {
        ...
        field(8; Quantity; Decimal)
        {
            ...
            begin
                ...
                if Quantity > "Quantity Requested" then Error(Text007);
            end;
        }
    ...
    begin
        ...
        //ItemLedgerEntry.SETRANGE(ItemLedgerEntry."Global Dimension 1 Code","Shortcut Dimension 1 Code");
        //ItemLedgerEntry.SETRANGE(ItemLedgerEntry."Global Dimension 2 Code","Shortcut Dimension 2 Code");
        ItemLedgerEntry.CalcSums(Quantity);

        "Qty in store" := ItemLedgerEntry.Quantity;
    end;
}
