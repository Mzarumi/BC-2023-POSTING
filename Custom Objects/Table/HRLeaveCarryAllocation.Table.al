table 52185530 "HR Leave Carry Allocation"
{
        ...
        field(1; "Application Code"; Code[20])
        {
            ...
            begin
                ...
                if "Application Code" <> xRec."Application Code" then begin
                    HRSetup.Get;
                    //NoSeriesMgtTestManual(HRSetup."Leave Carry Over App Nos.");
                    Description := '';
                end;
            end;
        }
    ...
    begin
        ...
        if "Application Code" = '' then begin
            ...
            //NoSeriesMgtInitSeries(HRSetup."Leave Carry Over App Nos.", xRec."No series", 0D, "Application Code", "No series");
        end;
