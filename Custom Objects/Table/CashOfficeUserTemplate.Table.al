table 52185873 "Cash Office User Template"
{
    ...
    fields
    {
        ...
        field(10; "Default Receipts Bank"; Code[20])
        {
            ...
            TableRelation = "Bank Account"."No." WHERE ("Bank Type" = FILTER (Cash | "Chq Collection" | Cashier));

            trigger OnValidate()
            begin
                /*Check if the batch has been allocated to another user*/
                if "Default Receipts Bank" <> '' then begin
                    UserTemp.Reset;
