table 52185736 "Loan Disbursement Header"
{
    ...
    fields
    {
        field(1; "No."; Code[20])
        {
            ...
            begin
                if "No." <> xRec."No." then begin
                    MembNoSeries.Get;
                    //NoSeriesMgtTestManual(MembNoSeries."Loan Batch Nos");
                    "No. Series" := '';
        ...
        {
            TableRelation = "Product Factory"."Product ID" WHERE(Status = CONST(Active),
                                                                  "Product Class Type" = CONST(Loan));
        ...
        field(30; "Member No"; Code[10])
        {
            Description = 'Used in Partial Disbursment of Mortgage Loan';
    ...
    begin
        ...
        if "No." = '' then begin
            ...
            //NoSeriesMgtInitSeries(MembNoSeries."Loan Batch Nos", xRec."No. Series", 0D, "No.", "No. Series");
        end;
