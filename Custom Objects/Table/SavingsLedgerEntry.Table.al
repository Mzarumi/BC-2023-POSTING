table 52185732 "Savings Ledger Entry"
{
    ...
    fields
    {
        ...
        field(50005; "Approver ID"; Code[30])
        {
        ...
        field(50007; "Dimension Set ID"; Integer)
        {
        ...
        field(50008; "Date Modified"; Date)
        {
        }
        field(50009; "Creation Time"; Time)
        {
        }
        field(50010; "PC Posting Name"; Code[100])
        {
        }
    ...
    //[Scope('Internal')]
    procedure DrillDownOnEntries(var CustLedger: Record "Savings Ledger Entry")
    var
    ...
    begin
        //DimMgt.et("Dimension Set ID",STRSUBSTNO('%1 %2',TABLECAPTION,"Entry No."));
    end;
}
