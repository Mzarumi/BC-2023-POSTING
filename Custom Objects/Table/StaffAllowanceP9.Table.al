table 52185918 "Staff Allowance P9"
{
    ...
    fields
    {
        ...
        {
            //TableRelation = Table39004043.Field1;
        }
        ...
        {
            //TableRelation = Table39004006.Field4;
        }
        ...
        {
            //TableRelation = Table39004028;
        }
        field(25; "PV No."; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(26; "Allowance Code"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    keys
    {
        key(Key1; "Employee Code", "Payroll Period", "PV No.", "Allowance Code")
        {
            Clustered = true;
        }
    }
