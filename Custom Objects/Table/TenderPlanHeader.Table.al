table 52185993 "Tender Plan Header"
{
    ...
    fields
    {
        ...
        {
            TableRelation = "PR Period Transactions"."Employee Code";
            ...
            begin
                ...
                */
                ...
                "Procurement Method Name" := Procumethod."Transaction Code";
    ...
    var
        ...
        WorkPlanAct: Text[30];
        Procumethod: Record "PR Period Transactions";
}
