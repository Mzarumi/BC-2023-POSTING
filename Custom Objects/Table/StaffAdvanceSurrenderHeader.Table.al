table 52185916 "Staff Advance Surrender Header"
{
        ...
        field(1; No; Code[20])
        {
            ...
            begin
                ...
                if No <> xRec.No then begin
                    GenLedgerSetup.Get;
                    //NoSeriesMgtTestManual(GenLedgerSetup."Staff Advance Surrender No.");
                    "No. Series" := '';
                end;
            end;
        }
                ...
                if PayLine.Find('-') then /*Copy the lines to the line table in the database*/
                  begin
                    repeat
                        ...
                        //mmmmImpSurrLine."Account No:":=PayLine."Account No:";
                        ...
                        ImpSurrLine."Account Name" := PayLine.Purpose;//PayLine."Account Name";
    ...
    begin
        if No = '' then begin
            ...
            //NoSeriesMgtInitSeries(GenLedgerSetup."Staff Advance Surrender No.", xRec."No. Series", 0D, No, "No. Series");
        end;
