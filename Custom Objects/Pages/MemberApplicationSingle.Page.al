            ...
            group("Other Information")
            {
                ...
                field("Recruited By"; Rec."Recruited By")
                {
                    ...
                    begin
                        ...
                        //         DelegateMemberss.SetRange(Rec."Delegate MNO.", Rec."Recruited By");
            ...
            group("Request Approval")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    begin
                        ...
                        if Rec."Recruited by Type" <> Rec."Recruited by Type"::Self then Rec.TestField("Recruited By");
                        ...
                        case Rec."Single Party/Multiple/Business" of
                            Rec."Single Party/Multiple/Business"::Single:
                                begin
                                    ...
                                    Rec.TestField("Mobile Phone No"); /*TESTFIELD("Recruited By");*/ //TESTFIELD("Electrol Zone");
                                    ...
                                    /*TESTFIELD("Bank Code"); TESTFIELD("Branch Code"); TESTFIELD("Bank Account No.");*/
                                end;
                        end;

                        NextofKINApplication.Reset;
                        NextofKINApplication.SetRange(NextofKINApplication."Account No", Rec."No.");
