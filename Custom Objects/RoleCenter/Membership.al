page 52186900 Membership
{
    Caption = 'Credit Mangement';
    PageType = RoleCenter;
    ...
    actions
    {
        area(embedding)
        {
            ...
            action(SalesOrdersComplShtNotInv)
            {
                ...
                ToolTip = 'View member single list.';
            }
            action(Items)
            {
                ApplicationArea = Basic, Suite;
        ...
        area(creation)
        {
            action("Sales &Quote")
            {
                ...
                ToolTip = 'Create a new/View Products.';
            }
...
#else
                action("Rejected Members")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = '&Rejected Members';
                    Image = SalesPrices;
...
#endif
                action("Salutation Titles")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Salutation Titles';
                    Image = CustomerRating;
                    RunObject = Page "Salutation Tittles";
...
profile Membership
{
    ProfileDescription = 'Membership';
    RoleCenter = Membership;
    Caption = 'Membership';
}